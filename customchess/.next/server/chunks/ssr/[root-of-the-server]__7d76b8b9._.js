...
function Piece({ position, image, posibleMoves, chessboard }) {
    ...
    const handleClick = ()=>{
        ...
        showPossibleMoves(position, posibleMoves, chessboard);
    };
...
function showPossibleMoves(position, posibleMoves, chessboard) {
    posibleMoves.forEach((move)=>{
        console.log(`Move: dx=${move.dx}, dy=${move.dy}, repeat=${move.repeat}`);
        chessboard[position.row + move.dy][position.col + move.dx];
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d76b8b9._.js.map